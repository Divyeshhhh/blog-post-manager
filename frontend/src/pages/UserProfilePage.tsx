...
export const UserProfilePage: React.FC = () => {
  ...
  const isOwnProfile = currentUser?.id === Number(userId) || (!userId && currentUser);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 text-xl text-gray-700 font-medium">Loading profile...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
        <div className="text-center bg-white p-8 rounded-2xl shadow-xl">
          ...
          <p className="text-xl text-gray-600 font-semibold mb-4">User not found</p>
          <button
            onClick={() => navigate('/')}
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden mb-8 border border-gray-100">
          {/* Cover Background */}
          <div className="h-32 md:h-48 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 relative">
              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    ...
                    {user.bio && (
                      <p className="text-gray-700 max-w-2xl leading-relaxed bg-gray-50 p-4 rounded-xl border border-gray-200">
                        {user.bio}
                      </p>
                    )}
                  </div>
          ...
          {posts.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-3xl shadow-xl border border-gray-100">
              ...
              <p className="text-gray-500 mb-6">
                {isOwnProfile ? 'Share your first story with the community' : 'Check back later for new content'}
              </p>
              {isOwnProfile && (
                <button
